...
{
    auto NewGameBounce = std::make_unique<UI::ScaleEffect>(m_NewGameBtn.getSprite(), 0.f, BOUNCE_DURATION, BOUNCE_SCALE);
    ...
    auto SavedGameBounce = std::make_unique<UI::ScaleEffect>(m_SavedGameBtn.getSprite(), 0.f, BOUNCE_DURATION, BOUNCE_SCALE);
    ...
    auto ExitBounce = std::make_unique<UI::ScaleEffect>(m_ExitBtn.getSprite(), 0.f, BOUNCE_DURATION, BOUNCE_SCALE);
    ...
    auto SettingBounce = std::make_unique<UI::ScaleEffect>(m_SettingBtn.getSprite(), 0.f, BOUNCE_DURATION, BOUNCE_SCALE);
    ...
    auto AboutBounce = std::make_unique<UI::ScaleEffect>(m_AboutBtn.getSprite(), 0.f, BOUNCE_DURATION, BOUNCE_SCALE);
